...
<div class="row">
	...
	<div class="col-sm-4">
		...
		<form action="../../backend/controller/user_cliente.php" method="post">
							...
							<input type="text" name="tlf_cli" id="tlf_cli" class="form-control" placeholder="..." minlength="11" maxlength="11" 
							pattern="[0-9]{11,11}" title="Solo numeros !" 
		...
		<table>
			...
			?>
				<tr>
						...
						<td>
							<form action="user_cliente.php" method="post">
								 <input type="hidden" name="cod_cli" value="<?php echo $data['cod_cli']?>">
