...
<form action="../../backend/controller/ventas_user.php" method="post">

	<input type="text" name="nom_cli" id="nom_cli" class="form-control" placeholder="Cliente" value="<?php
            					...
            					if(isset($dataR['nom_cli'])){
           						 ...
           						 ?>">
	<br>
	<input type="text" name="nom_pro" id="nom_pro" class="form-control" placeholder="nombre del producto" value="<?php
            					...
            					if(isset($dataR['nom_pro'])){
           						 ...
           						 ?>">
	<br>
	<input type="text" name="num_pro" id="num_pro" class="form-control" placeholder="Cantidad del producto" value="<?php
            					...
            					if(isset($dataR['num_pro'])){
           						 ...
           						 ?>">
	<br>
	<input type="text" name="pre_pro" id="pre_pro" class="form-control" placeholder="Precio del producto" value="<?php
				...
				while($data = $ventas->data_box()){
					...
					if ($data['sta_ven']== 0) {
						 ...
						 <tr>
						 	...
						 	<td>
							<form action="user_ventas.php" method="post">
								 <input type="hidden" name="id_ven" value="<?php echo $data['id_ven']?>">
